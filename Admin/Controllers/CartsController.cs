...
namespace Admin.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(ShopeaseContext context)
        {
            _context = context;
        }
        ...
        {
            var shopeaseContext = _context.Carts.Include(c => c.User);
        ...
        public async Task<IActionResult> Create([Bind("CartId,UserId,CreatedAt")] Cart cart)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Customers, "UserId", "UserId", cart.UserId);
            return View(cart);
        }

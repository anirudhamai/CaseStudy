...
//     if (selectedCategory) {
//       navigate(`/category/electronics`, {state:{ categoryId: 1, categoryName: 'Electronics'}});
//     }
//   };
...
function Navbar() {
  ...
  const handleSuggestionClick = (suggestion) => {
    ...
    // Navigate to a search results page or other specific page based on the suggestion
